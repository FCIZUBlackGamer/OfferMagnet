...
public class RecyclerRequestAdapter extends RecyclerView.Adapter<RecyclerRequestAdapter.ViewHolder> {
    ...
    View alertLayout;
    RatingBar rateUser;
    TextView numberOfUsers, txtPath, txtfinish, pro_des,pro_name;
    ImageView pro_img;
              ...
              pro_name.setText(""+dataItem.get(position).getUser_name());
                ...
                Join.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        progressDialog.show();
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.1.22/Join.php",
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                stringStringHashMap.put("user_id", 5+"");

...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_NAME +
            ...
            + " varchar(200) not null, " + KEY_PASSWORD + " varchar(200) not null, " + KEY_STATE + " varchar(200) not null );";
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("insert into " + TABLE_NAME + " ( " + KEY_ID + ", " + KEY_USER_ID + ", " + KEY_NAME + ", " + KEY_GENDER + ", " + KEY_BIRTHDATE + ", " + KEY_CITY + ", " + KEY_PHONE + ", " + KEY_PASSWORD + ", " + KEY_STATE + ") values ( '1', 't', 't', '0', '1', 't', 't', '0', '0');");
    ...
    public boolean UpdateData(String id, String user_id, String name,String phone, String pass, String city, String gender, String state, String date) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
